...
class MobsightContentHandlerImpl : public ISAXContentHandlerImpl
{
public:
    MobsightContentHandlerImpl();
    virtual ~MobsightContentHandlerImpl();
    ...
    void MakeMobList(std::list<NarrowMobDef>& OutputList)const;
    void FreeMobList(std::list<NarrowMobDef>& OutputList)const;
...
private:
    ...
    std::list<MobDef> MobList;
}; // end class MobsightContentHandlerImpl
