...
typedef std::pair<bool,double> dialog_result_t;

void SyncSimplifyLinesDialogToConfig(HWND hWnd,const dialog_result_t* const param);

INT_PTR CALLBACK SimplifyLinesDialogProc(HWND hWnd,UINT uMsg,WPARAM wParam,LPARAM lParam)
{
    ...
    switch(uMsg)
        ...
        case WM_INITDIALOG:
            ...
            // sync
            SyncSimplifyLinesDialogToConfig(hWnd,param);
        ...
        case WM_COMMAND:
            ...
            switch(LOWORD(wParam))
                ...
                case IDOK:
                    ...
                    // get range
                    std::string str;
                    GET_EDIT_STRING(hWnd,IDC_TOLERANCE,str);
                    std::stringstream ss;
                    ss << str;
                    ss >> param->second;
...
void SyncSimplifyLinesDialogToConfig(HWND hWnd,const dialog_result_t* const param)
{
    ...
    std::stringstream ss;
    ss << param->second;
    SET_EDIT_STRING(hWnd,IDC_TOLERANCE,ss.str());
