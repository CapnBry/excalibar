...
function Load_WGL_ARB_pixel_format_float: Boolean;
...
begin
  ...
  if glext_ExtensionSupported('WGL_ARB_pixel_format_float', extstring) then
  begin
    Result := TRUE;
  end;
...
begin
  ...
  else if ext = 'WGL_ARB_pixel_format_float' then Result := Load_WGL_ARB_pixel_format_float
